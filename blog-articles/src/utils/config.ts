...
//   redirect_uri: "https://blog.cn/login", // 请修改成你的信息
...
const config: Config = {
  oauth_uri: "https://github.com/login/oauth/authorize",
  redirect_uri: "http://localhost:3000/login", // 请修改成你的信息
  client_id: "502176cec65773057a9e", // 请修改成你的信息
  client_secret: "65d444de381a026301a2c7cffb6952b9a86ac235" // 请修改成你的信息
};
