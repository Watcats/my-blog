...
exports.APP = {
	...
	FRONT_END_PATH: path.join(__dirname, '..', 'blog'),
};
...
exports.EMAIL = {
	account: argv.email_account || 'your email address like : i@myblog',
	password: argv.email_password || 'your email password',
	from: 'https://github.com/Watcats',
	admin: 'Watcats',
};
...
exports.GITHUB = {
	...
	// // 生产环境
  // redirect_url: 'http://blog.cn/login',
  // client_id: '*****',
	// client_secret: '*****',
...
exports.BAIDU = {
	site: argv.baidu_site || 'your baidu site domain like : myblog',
...
exports.INFO = {
	...
	github: 'https://github.com/Watcats',
